    ...
    <div id="about-modal" className="modal">
      <div className="modal-box">
        <div className="flex justify-around">
          <Image src="/android-chrome-512x512.png" height={140} width={140} title="icon" alt="name-pls.js" />
        </div>
        ...
        <p className="text-neutral my-8">
          Star it on <a href="https://github.com/wanghsinche/name-pls.js" target="_blank" rel="noreferrer" className="link">GITHUB</a>  ❤️ </p>
